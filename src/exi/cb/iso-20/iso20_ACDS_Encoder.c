...
#include "iso20_ACDS_Encoder.h"



static int encode_iso20_acds_TransformType(exi_bitstream_t* stream, const struct iso20_acds_TransformType* TransformType);
static int encode_iso20_acds_TransformsType(exi_bitstream_t* stream, const struct iso20_acds_TransformsType* TransformsType);
static int encode_iso20_acds_DSAKeyValueType(exi_bitstream_t* stream, const struct iso20_acds_DSAKeyValueType* DSAKeyValueType);
static int encode_iso20_acds_X509IssuerSerialType(exi_bitstream_t* stream, const struct iso20_acds_X509IssuerSerialType* X509IssuerSerialType);
static int encode_iso20_acds_DigestMethodType(exi_bitstream_t* stream, const struct iso20_acds_DigestMethodType* DigestMethodType);
static int encode_iso20_acds_RSAKeyValueType(exi_bitstream_t* stream, const struct iso20_acds_RSAKeyValueType* RSAKeyValueType);
static int encode_iso20_acds_CanonicalizationMethodType(exi_bitstream_t* stream, const struct iso20_acds_CanonicalizationMethodType* CanonicalizationMethodType);
static int encode_iso20_acds_SignatureMethodType(exi_bitstream_t* stream, const struct iso20_acds_SignatureMethodType* SignatureMethodType);
static int encode_iso20_acds_KeyValueType(exi_bitstream_t* stream, const struct iso20_acds_KeyValueType* KeyValueType);
static int encode_iso20_acds_ReferenceType(exi_bitstream_t* stream, const struct iso20_acds_ReferenceType* ReferenceType);
static int encode_iso20_acds_RetrievalMethodType(exi_bitstream_t* stream, const struct iso20_acds_RetrievalMethodType* RetrievalMethodType);
static int encode_iso20_acds_X509DataType(exi_bitstream_t* stream, const struct iso20_acds_X509DataType* X509DataType);
static int encode_iso20_acds_PGPDataType(exi_bitstream_t* stream, const struct iso20_acds_PGPDataType* PGPDataType);
static int encode_iso20_acds_SPKIDataType(exi_bitstream_t* stream, const struct iso20_acds_SPKIDataType* SPKIDataType);
static int encode_iso20_acds_SignedInfoType(exi_bitstream_t* stream, const struct iso20_acds_SignedInfoType* SignedInfoType);
static int encode_iso20_acds_SignatureValueType(exi_bitstream_t* stream, const struct iso20_acds_SignatureValueType* SignatureValueType);
static int encode_iso20_acds_KeyInfoType(exi_bitstream_t* stream, const struct iso20_acds_KeyInfoType* KeyInfoType);
static int encode_iso20_acds_ObjectType(exi_bitstream_t* stream, const struct iso20_acds_ObjectType* ObjectType);
static int encode_iso20_acds_SignatureType(exi_bitstream_t* stream, const struct iso20_acds_SignatureType* SignatureType);
static int encode_iso20_acds_RationalNumberType(exi_bitstream_t* stream, const struct iso20_acds_RationalNumberType* RationalNumberType);
static int encode_iso20_acds_MessageHeaderType(exi_bitstream_t* stream, const struct iso20_acds_MessageHeaderType* MessageHeaderType);
static int encode_iso20_acds_SignaturePropertyType(exi_bitstream_t* stream, const struct iso20_acds_SignaturePropertyType* SignaturePropertyType);
static int encode_iso20_acds_EVTechnicalStatusType(exi_bitstream_t* stream, const struct iso20_acds_EVTechnicalStatusType* EVTechnicalStatusType);
static int encode_iso20_acds_ACDS_VehiclePositioningReqType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_VehiclePositioningReqType* ACDS_VehiclePositioningReqType);
static int encode_iso20_acds_ACDS_VehiclePositioningResType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_VehiclePositioningResType* ACDS_VehiclePositioningResType);
static int encode_iso20_acds_ACDS_ConnectReqType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_ConnectReqType* ACDS_ConnectReqType);
static int encode_iso20_acds_ACDS_ConnectResType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_ConnectResType* ACDS_ConnectResType);
static int encode_iso20_acds_ACDS_SystemStatusReqType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_SystemStatusReqType* ACDS_SystemStatusReqType);
static int encode_iso20_acds_ACDS_SystemStatusResType(exi_bitstream_t* stream, const struct iso20_acds_ACDS_SystemStatusResType* ACDS_SystemStatusResType);
static int encode_iso20_acds_CLReqControlModeType(exi_bitstream_t* stream, const struct iso20_acds_CLReqControlModeType* CLReqControlModeType);
static int encode_iso20_acds_CLResControlModeType(exi_bitstream_t* stream, const struct iso20_acds_CLResControlModeType* CLResControlModeType);
static int encode_iso20_acds_ManifestType(exi_bitstream_t* stream, const struct iso20_acds_ManifestType* ManifestType);
static int encode_iso20_acds_SignaturePropertiesType(exi_bitstream_t* stream, const struct iso20_acds_SignaturePropertiesType* SignaturePropertiesType);
    ...
    while(!done)
    {
        ...
        case 0:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_characters(stream, TransformType->Algorithm.charactersLen, TransformType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 1;
                    }
            ...
            if (TransformType->XPath_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_characters(stream, TransformType->XPath.charactersLen, TransformType->XPath.characters, iso20_acds_XPath_CHARACTER_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (TransformType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, TransformType->ANY.bytesLen, TransformType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 4:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_TransformType(stream, &TransformsType->Transform);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 5;
                }
            ...
            if (DSAKeyValueType->P_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->P.bytesLen, DSAKeyValueType->P.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (DSAKeyValueType->G_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->G.bytesLen, DSAKeyValueType->G.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->Y.bytesLen, DSAKeyValueType->Y.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 7:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->Q.bytesLen, DSAKeyValueType->Q.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            if (DSAKeyValueType->J_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->J.bytesLen, DSAKeyValueType->J.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (DSAKeyValueType->Seed_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->Seed.bytesLen, DSAKeyValueType->Seed.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            if (DSAKeyValueType->PgenCounter_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DSAKeyValueType->PgenCounter.bytesLen, DSAKeyValueType->PgenCounter.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 13:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, X509IssuerSerialType->X509IssuerName.charactersLen, X509IssuerSerialType->X509IssuerName.characters, iso20_acds_X509IssuerName_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 15:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_characters(stream, DigestMethodType->Algorithm.charactersLen, DigestMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 16;
                    }
            ...
            if (DigestMethodType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, DigestMethodType->ANY.bytesLen, DigestMethodType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 17:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, RSAKeyValueType->Modulus.bytesLen, RSAKeyValueType->Modulus.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 18:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, RSAKeyValueType->Exponent.bytesLen, RSAKeyValueType->Exponent.bytes, iso20_acds_CryptoBinary_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 19:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_characters(stream, CanonicalizationMethodType->Algorithm.charactersLen, CanonicalizationMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 20;
                    }
            ...
            if (CanonicalizationMethodType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, CanonicalizationMethodType->ANY.bytesLen, CanonicalizationMethodType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 21:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_characters(stream, SignatureMethodType->Algorithm.charactersLen, SignatureMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 22;
                    }
            ...
            else if (SignatureMethodType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, SignatureMethodType->ANY.bytesLen, SignatureMethodType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 24:
            ...
            if (KeyValueType->DSAKeyValue_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_DSAKeyValueType(stream, &KeyValueType->DSAKeyValue);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyValueType->RSAKeyValue_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_RSAKeyValueType(stream, &KeyValueType->RSAKeyValue);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyValueType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, KeyValueType->ANY.bytesLen, KeyValueType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 25:
            ...
            if (ReferenceType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ReferenceType->Id.charactersLen, ReferenceType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 26;
                        }
            ...
            else if (ReferenceType->Type_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ReferenceType->Type.charactersLen, ReferenceType->Type.characters, iso20_acds_Type_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 27;
                        }
            ...
            else if (ReferenceType->URI_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ReferenceType->URI.charactersLen, ReferenceType->URI.characters, iso20_acds_URI_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 28;
                        }
            ...
            else if (ReferenceType->Transforms_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_TransformsType(stream, &ReferenceType->Transforms);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 29;
                    }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_DigestMethodType(stream, &ReferenceType->DigestMethod);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 30;
                    }
        ...
        case 30:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, ReferenceType->DigestValue.bytesLen, ReferenceType->DigestValue.bytes, iso20_acds_DigestValueType_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 31:
            ...
            if (RetrievalMethodType->Type_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, RetrievalMethodType->Type.charactersLen, RetrievalMethodType->Type.characters, iso20_acds_Type_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 32;
                        }
            ...
            else if (RetrievalMethodType->URI_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, RetrievalMethodType->URI.charactersLen, RetrievalMethodType->URI.characters, iso20_acds_URI_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 33;
                        }
            ...
            else if (RetrievalMethodType->Transforms_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_TransformsType(stream, &RetrievalMethodType->Transforms);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
        ...
        case 34:
            ...
            if (X509DataType->X509IssuerSerial_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_X509IssuerSerialType(stream, &X509DataType->X509IssuerSerial);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (X509DataType->X509SKI_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, X509DataType->X509SKI.bytesLen, X509DataType->X509SKI.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (X509DataType->X509SubjectName_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_characters(stream, X509DataType->X509SubjectName.charactersLen, X509DataType->X509SubjectName.characters, iso20_acds_X509SubjectName_CHARACTER_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (X509DataType->X509Certificate_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, X509DataType->X509Certificate.bytesLen, X509DataType->X509Certificate.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (X509DataType->X509CRL_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, X509DataType->X509CRL.bytesLen, X509DataType->X509CRL.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (X509DataType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, X509DataType->ANY.bytesLen, X509DataType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            if (PGPDataType->choice_1_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, PGPDataType->choice_1.PGPKeyID.bytesLen, PGPDataType->choice_1.PGPKeyID.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, PGPDataType->choice_1.PGPKeyPacket.bytesLen, PGPDataType->choice_1.PGPKeyPacket.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (PGPDataType->choice_1_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, PGPDataType->choice_1.ANY.bytesLen, PGPDataType->choice_1.ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 38:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, PGPDataType->choice_2.PGPKeyPacket.bytesLen, PGPDataType->choice_2.PGPKeyPacket.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            if (PGPDataType->choice_2_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, PGPDataType->choice_2.ANY.bytesLen, PGPDataType->choice_2.ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 40:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, SPKIDataType->SPKISexp.bytesLen, SPKIDataType->SPKISexp.bytes, iso20_acds_base64Binary_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            if (SPKIDataType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, SPKIDataType->ANY.bytesLen, SPKIDataType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 42:
            ...
            if (SignedInfoType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignedInfoType->Id.charactersLen, SignedInfoType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 43;
                        }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_CanonicalizationMethodType(stream, &SignedInfoType->CanonicalizationMethod);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 44;
                    }
        ...
        case 44:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_SignatureMethodType(stream, &SignedInfoType->SignatureMethod);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 45;
                }
        ...
        case 45:
            ...
            if (Reference_currentIndex < SignedInfoType->Reference.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_ReferenceType(stream, &SignedInfoType->Reference.array[Reference_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 46;
                    }
        ...
        case 50:
            ...
            if (SignatureValueType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignatureValueType->Id.charactersLen, SignatureValueType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 51;
                        }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, SignatureValueType->CONTENT.bytesLen, SignatureValueType->CONTENT.bytes, iso20_acds_SignatureValueType_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 2;
                        }
        ...
        case 52:
            ...
            if (KeyInfoType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, KeyInfoType->Id.charactersLen, KeyInfoType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 53;
                        }
            ...
            else if (KeyInfoType->KeyName_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_characters(stream, KeyInfoType->KeyName.charactersLen, KeyInfoType->KeyName.characters, iso20_acds_KeyName_CHARACTER_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (KeyInfoType->KeyValue_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_KeyValueType(stream, &KeyInfoType->KeyValue);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyInfoType->RetrievalMethod_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_RetrievalMethodType(stream, &KeyInfoType->RetrievalMethod);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyInfoType->X509Data_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_X509DataType(stream, &KeyInfoType->X509Data);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyInfoType->PGPData_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_PGPDataType(stream, &KeyInfoType->PGPData);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyInfoType->SPKIData_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_SPKIDataType(stream, &KeyInfoType->SPKIData);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
            ...
            else if (KeyInfoType->MgmtData_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_characters(stream, KeyInfoType->MgmtData.charactersLen, KeyInfoType->MgmtData.characters, iso20_acds_MgmtData_CHARACTER_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            ...
            else if (KeyInfoType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, KeyInfoType->ANY.bytesLen, KeyInfoType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 54:
            ...
            if (ObjectType->Encoding_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ObjectType->Encoding.charactersLen, ObjectType->Encoding.characters, iso20_acds_Encoding_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 55;
                        }
            ...
            else if (ObjectType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ObjectType->Id.charactersLen, ObjectType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 56;
                        }
            ...
            else if (ObjectType->MimeType_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ObjectType->MimeType.charactersLen, ObjectType->MimeType.characters, iso20_acds_MimeType_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 57;
                        }
            ...
            else if (ObjectType->ANY_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            error = exi_basetypes_encoder_bytes(stream, ObjectType->ANY.bytesLen, ObjectType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                            if (error == EXI_ERROR__NO_ERROR)
                            {
                                // encode END Element
                                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 58:
            ...
            if (SignatureType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignatureType->Id.charactersLen, SignatureType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 59;
                        }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_SignedInfoType(stream, &SignatureType->SignedInfo);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 60;
                    }
        ...
        case 60:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_SignatureValueType(stream, &SignatureType->SignatureValue);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 61;
                }
        ...
        case 61:
            ...
            if (SignatureType->KeyInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_KeyInfoType(stream, &SignatureType->KeyInfo);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 63;
                    }
            ...
            else if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_ObjectType(stream, &SignatureType->Object);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 62;
                    }
        ...
        case 67:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, MessageHeaderType->SessionID.bytesLen, MessageHeaderType->SessionID.bytes, iso20_acds_sessionIDType_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 69:
            ...
            if (MessageHeaderType->Signature_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_SignatureType(stream, &MessageHeaderType->Signature);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 2;
                    }
        ...
        case 70:
            ...
            if (SignaturePropertyType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignaturePropertyType->Id.charactersLen, SignaturePropertyType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 71;
                        }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignaturePropertyType->Target.charactersLen, SignaturePropertyType->Target.characters, iso20_acds_Target_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 72;
                        }
        ...
        case 72:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_bytes(stream, SignaturePropertyType->ANY.bytesLen, SignaturePropertyType->ANY.bytes, iso20_acds_anyType_BYTES_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            // encode END Element
                            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
...
static int encode_iso20_acds_EVTechnicalStatusType(exi_bitstream_t* stream, const struct iso20_acds_EVTechnicalStatusType* EVTechnicalStatusType) {
    ...
    while(!done)
    {
        ...
        case 75:
            ...
            else if (EVTechnicalStatusType->EVUWBStrength_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 1);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVUWBStrength, RationalNumberType); next=77
                    error = encode_iso20_acds_RationalNumberType(stream, &EVTechnicalStatusType->EVUWBStrength);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 77;
                    }
        ...
        case 76:
            ...
            if (EVTechnicalStatusType->EVUWBStrength_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
    ...
    while(!done)
    {
        ...
        case 81:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_VehiclePositioningReqType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 82;
                }
        ...
        case 82:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_VehiclePositioningReqType->EVMobilityStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 83:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_VehiclePositioningReqType->EVPositioningSupport);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 84:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_VehiclePositioningResType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 85;
                }
        ...
        case 85:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 6, ACDS_VehiclePositioningResType->ResponseCode);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 86:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_VehiclePositioningResType->EVSEProcessing);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 87:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_VehiclePositioningResType->EVSEPositioningSupport);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 88:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_integer_16(stream, ACDS_VehiclePositioningResType->EVRelativeXDeviation);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 89:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (int); next=90
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_integer_16(stream, ACDS_VehiclePositioningResType->EVRelativeYDeviation);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 90:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_integer_16(stream, ACDS_VehiclePositioningResType->ContactWindowXc);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 91:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_integer_16(stream, ACDS_VehiclePositioningResType->ContactWindowYc);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 92:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_VehiclePositioningResType->EVInChargePosition);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 93:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_ConnectReqType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 94;
                }
        ...
        case 94:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_ConnectReqType->EVElectricalChargingDeviceStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 95:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_ConnectResType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 96;
                }
        ...
        case 96:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 6, ACDS_ConnectResType->ResponseCode);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 97:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_ConnectResType->EVSEProcessing);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 98:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_ConnectResType->EVSEElectricalChargingDeviceStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 99:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_ConnectResType->EVSEMechanicalChargingDeviceStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
    ...
    while(!done)
    {
        ...
        case 100:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_SystemStatusReqType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 101;
                }
        ...
        case 101:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_EVTechnicalStatusType(stream, &ACDS_SystemStatusReqType->EVTechnicalStatus);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 2;
                }
    ...
    while(!done)
    {
        ...
        case 102:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                error = encode_iso20_acds_MessageHeaderType(stream, &ACDS_SystemStatusResType->Header);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 103;
                }
        ...
        case 103:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 6, ACDS_SystemStatusResType->ResponseCode);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 104:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_SystemStatusResType->EVSEMechanicalChargingDeviceStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 105:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVSEReadyToCharge);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 106:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 2, ACDS_SystemStatusResType->EVSEIsolationStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 107:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVSEDisabled);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 108:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVSEUtilityInterruptEvent);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 109:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=110
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVSEEmergencyShutdown);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 110:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVSEMalfunction);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 111:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVInChargePosition);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 112:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ACDS_SystemStatusResType->EVAssociationStatus);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // encode END Element
                        error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
        ...
        case 113:
            ...
            if (ManifestType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, ManifestType->Id.charactersLen, ManifestType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 118;
                        }
            ...
            else
            {
                if (Reference_currentIndex < ManifestType->Reference.arrayLen)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        ...
                        error = encode_iso20_acds_ReferenceType(stream, &ManifestType->Reference.array[Reference_currentIndex++]);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 114;
                        }
        ...
        case 123:
            ...
            if (SignaturePropertiesType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_characters(stream, SignaturePropertiesType->Id.charactersLen, SignaturePropertiesType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 125;
                        }
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    ...
                    error = encode_iso20_acds_SignaturePropertyType(stream, &SignaturePropertiesType->SignatureProperty);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 124;
                    }
...
int encode_iso20_acds_exiDocument(exi_bitstream_t* stream, struct iso20_acds_exiDocument* exiDoc)
{
    int error = exi_header_write(stream);

    if (error == EXI_ERROR__NO_ERROR)
    {
        if (exiDoc->ACDS_ConnectReq_isUsed == 1)
        {
            // encode event 0
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_ConnectReqType(stream, &exiDoc->ACDS_ConnectReq);
            }
        }
        else if (exiDoc->ACDS_DisconnectReq_isUsed == 1)
        {
            // encode event 1
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 1);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_ConnectReqType(stream, &exiDoc->ACDS_DisconnectReq);
            }
        }
        else if (exiDoc->ACDS_ConnectRes_isUsed == 1)
        {
            // encode event 2
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 2);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_ConnectResType(stream, &exiDoc->ACDS_ConnectRes);
            }
        }
        else if (exiDoc->ACDS_DisconnectRes_isUsed == 1)
        {
            // encode event 3
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 3);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_ConnectResType(stream, &exiDoc->ACDS_DisconnectRes);
            }
        }
        else if (exiDoc->ACDS_SystemStatusReq_isUsed == 1)
        {
            // encode event 4
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 4);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_SystemStatusReqType(stream, &exiDoc->ACDS_SystemStatusReq);
            }
        }
        else if (exiDoc->ACDS_SystemStatusRes_isUsed == 1)
        {
            // encode event 5
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 5);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_SystemStatusResType(stream, &exiDoc->ACDS_SystemStatusRes);
            }
        }
        else if (exiDoc->ACDS_VehiclePositioningReq_isUsed == 1)
        {
            // encode event 6
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 6);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_VehiclePositioningReqType(stream, &exiDoc->ACDS_VehiclePositioningReq);
            }
        }
        else if (exiDoc->ACDS_VehiclePositioningRes_isUsed == 1)
        {
            // encode event 7
            error = exi_basetypes_encoder_nbit_uint(stream, 6, 7);
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ACDS_VehiclePositioningResType(stream, &exiDoc->ACDS_VehiclePositioningRes);
            }
        }
        else if (exiDoc->CLReqControlMode_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_CLReqControlModeType(stream, &exiDoc->CLReqControlMode);
            }
        }
        else if (exiDoc->CLResControlMode_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_CLResControlModeType(stream, &exiDoc->CLResControlMode);
            }
        }
        else if (exiDoc->CanonicalizationMethod_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_CanonicalizationMethodType(stream, &exiDoc->CanonicalizationMethod);
            }
        }
        else if (exiDoc->DSAKeyValue_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_DSAKeyValueType(stream, &exiDoc->DSAKeyValue);
            }
        }
        else if (exiDoc->DigestMethod_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_DigestMethodType(stream, &exiDoc->DigestMethod);
            }
        }
        // simple type! encode_iso20_acds_DigestValue;
        else if (exiDoc->KeyInfo_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_KeyInfoType(stream, &exiDoc->KeyInfo);
            }
        }
        // simple type! encode_iso20_acds_KeyName;
        else if (exiDoc->KeyValue_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_KeyValueType(stream, &exiDoc->KeyValue);
            }
        }
        else if (exiDoc->Manifest_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ManifestType(stream, &exiDoc->Manifest);
            }
        }
        // simple type! encode_iso20_acds_MgmtData;
        else if (exiDoc->Object_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ObjectType(stream, &exiDoc->Object);
            }
        }
        else if (exiDoc->PGPData_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_PGPDataType(stream, &exiDoc->PGPData);
            }
        }
        else if (exiDoc->RSAKeyValue_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_RSAKeyValueType(stream, &exiDoc->RSAKeyValue);
            }
        }
        else if (exiDoc->Reference_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_ReferenceType(stream, &exiDoc->Reference);
            }
        }
        else if (exiDoc->RetrievalMethod_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_RetrievalMethodType(stream, &exiDoc->RetrievalMethod);
            }
        }
        else if (exiDoc->SPKIData_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SPKIDataType(stream, &exiDoc->SPKIData);
            }
        }
        else if (exiDoc->SignatureMethod_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignatureMethodType(stream, &exiDoc->SignatureMethod);
            }
        }
        else if (exiDoc->SignatureProperties_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignaturePropertiesType(stream, &exiDoc->SignatureProperties);
            }
        }
        else if (exiDoc->SignatureProperty_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignaturePropertyType(stream, &exiDoc->SignatureProperty);
            }
        }
        else if (exiDoc->Signature_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignatureType(stream, &exiDoc->Signature);
            }
        }
        else if (exiDoc->SignatureValue_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignatureValueType(stream, &exiDoc->SignatureValue);
            }
        }
        else if (exiDoc->SignedInfo_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_SignedInfoType(stream, &exiDoc->SignedInfo);
            }
        }
        else if (exiDoc->Transform_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_TransformType(stream, &exiDoc->Transform);
            }
        }
        else if (exiDoc->Transforms_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_TransformsType(stream, &exiDoc->Transforms);
            }
        }
        else if (exiDoc->X509Data_isUsed == 1)
        {
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                error = encode_iso20_acds_X509DataType(stream, &exiDoc->X509Data);
            }
        }
        else
        {
