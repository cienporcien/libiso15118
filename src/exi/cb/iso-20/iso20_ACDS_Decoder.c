...
#include "iso20_ACDS_Decoder.h"



static int decode_iso20_acds_TransformType(exi_bitstream_t* stream, struct iso20_acds_TransformType* TransformType);
static int decode_iso20_acds_TransformsType(exi_bitstream_t* stream, struct iso20_acds_TransformsType* TransformsType);
static int decode_iso20_acds_DSAKeyValueType(exi_bitstream_t* stream, struct iso20_acds_DSAKeyValueType* DSAKeyValueType);
static int decode_iso20_acds_X509IssuerSerialType(exi_bitstream_t* stream, struct iso20_acds_X509IssuerSerialType* X509IssuerSerialType);
static int decode_iso20_acds_DigestMethodType(exi_bitstream_t* stream, struct iso20_acds_DigestMethodType* DigestMethodType);
static int decode_iso20_acds_RSAKeyValueType(exi_bitstream_t* stream, struct iso20_acds_RSAKeyValueType* RSAKeyValueType);
static int decode_iso20_acds_CanonicalizationMethodType(exi_bitstream_t* stream, struct iso20_acds_CanonicalizationMethodType* CanonicalizationMethodType);
static int decode_iso20_acds_SignatureMethodType(exi_bitstream_t* stream, struct iso20_acds_SignatureMethodType* SignatureMethodType);
static int decode_iso20_acds_KeyValueType(exi_bitstream_t* stream, struct iso20_acds_KeyValueType* KeyValueType);
static int decode_iso20_acds_ReferenceType(exi_bitstream_t* stream, struct iso20_acds_ReferenceType* ReferenceType);
static int decode_iso20_acds_RetrievalMethodType(exi_bitstream_t* stream, struct iso20_acds_RetrievalMethodType* RetrievalMethodType);
static int decode_iso20_acds_X509DataType(exi_bitstream_t* stream, struct iso20_acds_X509DataType* X509DataType);
static int decode_iso20_acds_PGPDataType(exi_bitstream_t* stream, struct iso20_acds_PGPDataType* PGPDataType);
static int decode_iso20_acds_SPKIDataType(exi_bitstream_t* stream, struct iso20_acds_SPKIDataType* SPKIDataType);
static int decode_iso20_acds_SignedInfoType(exi_bitstream_t* stream, struct iso20_acds_SignedInfoType* SignedInfoType);
static int decode_iso20_acds_SignatureValueType(exi_bitstream_t* stream, struct iso20_acds_SignatureValueType* SignatureValueType);
static int decode_iso20_acds_KeyInfoType(exi_bitstream_t* stream, struct iso20_acds_KeyInfoType* KeyInfoType);
static int decode_iso20_acds_ObjectType(exi_bitstream_t* stream, struct iso20_acds_ObjectType* ObjectType);
static int decode_iso20_acds_SignatureType(exi_bitstream_t* stream, struct iso20_acds_SignatureType* SignatureType);
static int decode_iso20_acds_RationalNumberType(exi_bitstream_t* stream, struct iso20_acds_RationalNumberType* RationalNumberType);
static int decode_iso20_acds_MessageHeaderType(exi_bitstream_t* stream, struct iso20_acds_MessageHeaderType* MessageHeaderType);
static int decode_iso20_acds_SignaturePropertyType(exi_bitstream_t* stream, struct iso20_acds_SignaturePropertyType* SignaturePropertyType);
static int decode_iso20_acds_EVTechnicalStatusType(exi_bitstream_t* stream, struct iso20_acds_EVTechnicalStatusType* EVTechnicalStatusType);
static int decode_iso20_acds_ACDS_VehiclePositioningReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_VehiclePositioningReqType* ACDS_VehiclePositioningReqType);
static int decode_iso20_acds_ACDS_VehiclePositioningResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_VehiclePositioningResType* ACDS_VehiclePositioningResType);
static int decode_iso20_acds_ACDS_ConnectReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_ConnectReqType* ACDS_ConnectReqType);
static int decode_iso20_acds_ACDS_ConnectResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_ConnectResType* ACDS_ConnectResType);
static int decode_iso20_acds_ACDS_SystemStatusReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_SystemStatusReqType* ACDS_SystemStatusReqType);
static int decode_iso20_acds_ACDS_SystemStatusResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_SystemStatusResType* ACDS_SystemStatusResType);
static int decode_iso20_acds_CLReqControlModeType(exi_bitstream_t* stream, struct iso20_acds_CLReqControlModeType* CLReqControlModeType);
static int decode_iso20_acds_CLResControlModeType(exi_bitstream_t* stream, struct iso20_acds_CLResControlModeType* CLResControlModeType);
static int decode_iso20_acds_ManifestType(exi_bitstream_t* stream, struct iso20_acds_ManifestType* ManifestType);
static int decode_iso20_acds_SignaturePropertiesType(exi_bitstream_t* stream, struct iso20_acds_SignaturePropertiesType* SignaturePropertiesType);
...
static int decode_iso20_acds_TransformType(exi_bitstream_t* stream, struct iso20_acds_TransformType* TransformType) {
    ...
    init_iso20_acds_TransformType(TransformType);
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (TransformType->Algorithm.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, TransformType->Algorithm.charactersLen, TransformType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                        }
                        else
                        {
        ...
        case 1:
            ...
            if (error == 0)
            {
                        ...
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                if (TransformType->XPath.charactersLen >= 2)
                                {
                                    ...
                                    error = exi_basetypes_decoder_characters(stream, TransformType->XPath.charactersLen, TransformType->XPath.characters, iso20_acds_XPath_CHARACTER_SIZE);
                                }
                                else
                                {
                                    // the string seems to be in the table, but this is not supported
                ...
                case 3:
                    ...
                    error = decode_exi_type_hex_binary(stream, &TransformType->ANY.bytesLen, &TransformType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_TransformsType(exi_bitstream_t* stream, struct iso20_acds_TransformsType* TransformsType) {
    ...
    init_iso20_acds_TransformsType(TransformsType);
        ...
        case 4:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_TransformType(stream, &TransformsType->Transform);
                    if (error == 0)
                    {
                        grammar_id = 5;
                    }
...
static int decode_iso20_acds_DSAKeyValueType(exi_bitstream_t* stream, struct iso20_acds_DSAKeyValueType* DSAKeyValueType) {
    ...
    init_iso20_acds_DSAKeyValueType(DSAKeyValueType);
        ...
        case 6:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->P.bytesLen, &DSAKeyValueType->P.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                ...
                case 1:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->G.bytesLen, &DSAKeyValueType->G.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                ...
                case 2:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->Y.bytesLen, &DSAKeyValueType->Y.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 10;
                    }
        ...
        case 7:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->Q.bytesLen, &DSAKeyValueType->Q.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
        ...
        case 10:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->J.bytesLen, &DSAKeyValueType->J.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                ...
                case 1:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->Seed.bytesLen, &DSAKeyValueType->Seed.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
        ...
        case 12:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DSAKeyValueType->PgenCounter.bytesLen, &DSAKeyValueType->PgenCounter.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_X509IssuerSerialType(exi_bitstream_t* stream, struct iso20_acds_X509IssuerSerialType* X509IssuerSerialType) {
    ...
    init_iso20_acds_X509IssuerSerialType(X509IssuerSerialType);
                        ...
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                if (X509IssuerSerialType->X509IssuerName.charactersLen >= 2)
                                {
                                    ...
                                    error = exi_basetypes_decoder_characters(stream, X509IssuerSerialType->X509IssuerName.charactersLen, X509IssuerSerialType->X509IssuerName.characters, iso20_acds_X509IssuerName_CHARACTER_SIZE);
                                }
                                else
                                {
                                    // the string seems to be in the table, but this is not supported
...
static int decode_iso20_acds_DigestMethodType(exi_bitstream_t* stream, struct iso20_acds_DigestMethodType* DigestMethodType) {
    ...
    init_iso20_acds_DigestMethodType(DigestMethodType);
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (DigestMethodType->Algorithm.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, DigestMethodType->Algorithm.charactersLen, DigestMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
        ...
        case 16:
            ...
            if (error == 0)
            {
                ...
                case 2:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &DigestMethodType->ANY.bytesLen, &DigestMethodType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_RSAKeyValueType(exi_bitstream_t* stream, struct iso20_acds_RSAKeyValueType* RSAKeyValueType) {
    ...
    init_iso20_acds_RSAKeyValueType(RSAKeyValueType);
        ...
        case 17:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &RSAKeyValueType->Modulus.bytesLen, &RSAKeyValueType->Modulus.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 18;
                    }
        ...
        case 18:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &RSAKeyValueType->Exponent.bytesLen, &RSAKeyValueType->Exponent.bytes[0], iso20_acds_CryptoBinary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 2;
                    }
...
static int decode_iso20_acds_CanonicalizationMethodType(exi_bitstream_t* stream, struct iso20_acds_CanonicalizationMethodType* CanonicalizationMethodType) {
    ...
    init_iso20_acds_CanonicalizationMethodType(CanonicalizationMethodType);
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (CanonicalizationMethodType->Algorithm.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, CanonicalizationMethodType->Algorithm.charactersLen, CanonicalizationMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
        ...
        case 20:
            ...
            if (error == 0)
            {
                ...
                case 2:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &CanonicalizationMethodType->ANY.bytesLen, &CanonicalizationMethodType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_SignatureMethodType(exi_bitstream_t* stream, struct iso20_acds_SignatureMethodType* SignatureMethodType) {
    ...
    init_iso20_acds_SignatureMethodType(SignatureMethodType);
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignatureMethodType->Algorithm.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignatureMethodType->Algorithm.charactersLen, SignatureMethodType->Algorithm.characters, iso20_acds_Algorithm_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
        ...
        case 22:
            ...
            if (error == 0)
            {
                ...
                case 3:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &SignatureMethodType->ANY.bytesLen, &SignatureMethodType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_KeyValueType(exi_bitstream_t* stream, struct iso20_acds_KeyValueType* KeyValueType) {
    ...
    init_iso20_acds_KeyValueType(KeyValueType);
        ...
        case 24:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_DSAKeyValueType(stream, &KeyValueType->DSAKeyValue);
                    if (error == 0)
                    {
                ...
                case 1:
                    ...
                    // decode: element
                    error = decode_iso20_acds_RSAKeyValueType(stream, &KeyValueType->RSAKeyValue);
                    if (error == 0)
                    {
                ...
                case 2:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &KeyValueType->ANY.bytesLen, &KeyValueType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_ReferenceType(exi_bitstream_t* stream, struct iso20_acds_ReferenceType* ReferenceType) {
    ...
    init_iso20_acds_ReferenceType(ReferenceType);
        ...
        case 25:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (ReferenceType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ReferenceType->Id.charactersLen, ReferenceType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    if (error == 0)
                    {
                        if (ReferenceType->Type.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ReferenceType->Type.charactersLen, ReferenceType->Type.characters, iso20_acds_Type_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 2:
                    ...
                    if (error == 0)
                    {
                        if (ReferenceType->URI.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ReferenceType->URI.charactersLen, ReferenceType->URI.characters, iso20_acds_URI_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 3:
                    ...
                    // decode: element
                    error = decode_iso20_acds_TransformsType(stream, &ReferenceType->Transforms);
                    if (error == 0)
                    {
                ...
                case 4:
                    ...
                    // decode: element
                    error = decode_iso20_acds_DigestMethodType(stream, &ReferenceType->DigestMethod);
                    if (error == 0)
                    {
                        grammar_id = 30;
                    }
        ...
        case 30:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &ReferenceType->DigestValue.bytesLen, &ReferenceType->DigestValue.bytes[0], iso20_acds_DigestValueType_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 2;
                    }
...
static int decode_iso20_acds_RetrievalMethodType(exi_bitstream_t* stream, struct iso20_acds_RetrievalMethodType* RetrievalMethodType) {
    ...
    init_iso20_acds_RetrievalMethodType(RetrievalMethodType);
        ...
        case 31:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (RetrievalMethodType->Type.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, RetrievalMethodType->Type.charactersLen, RetrievalMethodType->Type.characters, iso20_acds_Type_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    if (error == 0)
                    {
                        if (RetrievalMethodType->URI.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, RetrievalMethodType->URI.charactersLen, RetrievalMethodType->URI.characters, iso20_acds_URI_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 2:
                    ...
                    // decode: element
                    error = decode_iso20_acds_TransformsType(stream, &RetrievalMethodType->Transforms);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_X509DataType(exi_bitstream_t* stream, struct iso20_acds_X509DataType* X509DataType) {
    ...
    init_iso20_acds_X509DataType(X509DataType);
        ...
        case 34:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_X509IssuerSerialType(stream, &X509DataType->X509IssuerSerial);
                    if (error == 0)
                    {
                ...
                case 1:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &X509DataType->X509SKI.bytesLen, &X509DataType->X509SKI.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                        ...
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                if (X509DataType->X509SubjectName.charactersLen >= 2)
                                {
                                    ...
                                    error = exi_basetypes_decoder_characters(stream, X509DataType->X509SubjectName.charactersLen, X509DataType->X509SubjectName.characters, iso20_acds_X509SubjectName_CHARACTER_SIZE);
                                }
                                else
                                {
                                    // the string seems to be in the table, but this is not supported
                ...
                case 3:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &X509DataType->X509Certificate.bytesLen, &X509DataType->X509Certificate.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                ...
                case 4:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &X509DataType->X509CRL.bytesLen, &X509DataType->X509CRL.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                ...
                case 5:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &X509DataType->ANY.bytesLen, &X509DataType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_PGPDataType(exi_bitstream_t* stream, struct iso20_acds_PGPDataType* PGPDataType) {
    ...
    init_iso20_acds_PGPDataType(PGPDataType);
        ...
        case 35:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &PGPDataType->choice_1.PGPKeyID.bytesLen, &PGPDataType->choice_1.PGPKeyID.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 36;
                    }
                ...
                case 1:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &PGPDataType->choice_1.PGPKeyPacket.bytesLen, &PGPDataType->choice_1.PGPKeyPacket.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
        ...
        case 36:
            ...
            if (error == 0)
            {
                ...
                case 3:
                    // Event: START (ANY, anyType (base64Binary)); next=38
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &PGPDataType->choice_1.ANY.bytesLen, &PGPDataType->choice_1.ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
        ...
        case 38:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &PGPDataType->choice_2.PGPKeyPacket.bytesLen, &PGPDataType->choice_2.PGPKeyPacket.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 39;
                    }
        ...
        case 39:
            ...
            if (error == 0)
            {
                ...
                case 2:
                    // Event: START (ANY, anyType (base64Binary)); next=38
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &PGPDataType->choice_2.ANY.bytesLen, &PGPDataType->choice_2.ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_SPKIDataType(exi_bitstream_t* stream, struct iso20_acds_SPKIDataType* SPKIDataType) {
    ...
    init_iso20_acds_SPKIDataType(SPKIDataType);
        ...
        case 40:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &SPKIDataType->SPKISexp.bytesLen, &SPKIDataType->SPKISexp.bytes[0], iso20_acds_base64Binary_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 41;
                    }
        ...
        case 41:
            ...
            if (error == 0)
            {
                ...
                case 2:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &SPKIDataType->ANY.bytesLen, &SPKIDataType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_SignedInfoType(exi_bitstream_t* stream, struct iso20_acds_SignedInfoType* SignedInfoType) {
    ...
    init_iso20_acds_SignedInfoType(SignedInfoType);
        ...
        case 42:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignedInfoType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignedInfoType->Id.charactersLen, SignedInfoType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    // decode: element
                    error = decode_iso20_acds_CanonicalizationMethodType(stream, &SignedInfoType->CanonicalizationMethod);
                    if (error == 0)
                    {
                        grammar_id = 44;
                    }
        ...
        case 44:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SignatureMethodType(stream, &SignedInfoType->SignatureMethod);
                    if (error == 0)
                    {
                        grammar_id = 45;
                    }
        ...
        case 45:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (SignedInfoType->Reference.arrayLen < iso20_acds_ReferenceType_4_ARRAY_SIZE)
                    {
                        error = decode_iso20_acds_ReferenceType(stream, &SignedInfoType->Reference.array[SignedInfoType->Reference.arrayLen++]);
                    }
                    else
                    {
...
static int decode_iso20_acds_SignatureValueType(exi_bitstream_t* stream, struct iso20_acds_SignatureValueType* SignatureValueType) {
    ...
    init_iso20_acds_SignatureValueType(SignatureValueType);
        ...
        case 50:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignatureValueType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignatureValueType->Id.charactersLen, SignatureValueType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    if (error == 0)
                    {
                        error = exi_basetypes_decoder_bytes(stream, SignatureValueType->CONTENT.bytesLen, &SignatureValueType->CONTENT.bytes[0], iso20_acds_SignatureValueType_BYTES_SIZE);
                        if (error == 0)
                        {
                            grammar_id = 2;
                        }
...
static int decode_iso20_acds_KeyInfoType(exi_bitstream_t* stream, struct iso20_acds_KeyInfoType* KeyInfoType) {
    ...
    init_iso20_acds_KeyInfoType(KeyInfoType);
        ...
        case 52:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (KeyInfoType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, KeyInfoType->Id.charactersLen, KeyInfoType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                        ...
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                if (KeyInfoType->KeyName.charactersLen >= 2)
                                {
                                    ...
                                    error = exi_basetypes_decoder_characters(stream, KeyInfoType->KeyName.charactersLen, KeyInfoType->KeyName.characters, iso20_acds_KeyName_CHARACTER_SIZE);
                                }
                                else
                                {
                                    // the string seems to be in the table, but this is not supported
                ...
                case 2:
                    ...
                    // decode: element
                    error = decode_iso20_acds_KeyValueType(stream, &KeyInfoType->KeyValue);
                    if (error == 0)
                    {
                ...
                case 3:
                    ...
                    // decode: element
                    error = decode_iso20_acds_RetrievalMethodType(stream, &KeyInfoType->RetrievalMethod);
                    if (error == 0)
                    {
                ...
                case 4:
                    ...
                    // decode: element
                    error = decode_iso20_acds_X509DataType(stream, &KeyInfoType->X509Data);
                    if (error == 0)
                    {
                ...
                case 5:
                    ...
                    // decode: element
                    error = decode_iso20_acds_PGPDataType(stream, &KeyInfoType->PGPData);
                    if (error == 0)
                    {
                ...
                case 6:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SPKIDataType(stream, &KeyInfoType->SPKIData);
                    if (error == 0)
                    {
                        ...
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                if (KeyInfoType->MgmtData.charactersLen >= 2)
                                {
                                    ...
                                    error = exi_basetypes_decoder_characters(stream, KeyInfoType->MgmtData.charactersLen, KeyInfoType->MgmtData.characters, iso20_acds_MgmtData_CHARACTER_SIZE);
                                }
                                else
                                {
                                    // the string seems to be in the table, but this is not supported
                ...
                case 8:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &KeyInfoType->ANY.bytesLen, &KeyInfoType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_ObjectType(exi_bitstream_t* stream, struct iso20_acds_ObjectType* ObjectType) {
    ...
    init_iso20_acds_ObjectType(ObjectType);
        ...
        case 54:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (ObjectType->Encoding.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ObjectType->Encoding.charactersLen, ObjectType->Encoding.characters, iso20_acds_Encoding_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    if (error == 0)
                    {
                        if (ObjectType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ObjectType->Id.charactersLen, ObjectType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 2:
                    ...
                    if (error == 0)
                    {
                        if (ObjectType->MimeType.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ObjectType->MimeType.charactersLen, ObjectType->MimeType.characters, iso20_acds_MimeType_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 5:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &ObjectType->ANY.bytesLen, &ObjectType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_SignatureType(exi_bitstream_t* stream, struct iso20_acds_SignatureType* SignatureType) {
    ...
    init_iso20_acds_SignatureType(SignatureType);
        ...
        case 58:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignatureType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignatureType->Id.charactersLen, SignatureType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SignedInfoType(stream, &SignatureType->SignedInfo);
                    if (error == 0)
                    {
                        grammar_id = 60;
                    }
        ...
        case 60:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SignatureValueType(stream, &SignatureType->SignatureValue);
                    if (error == 0)
                    {
                        grammar_id = 61;
                    }
        ...
        case 61:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_KeyInfoType(stream, &SignatureType->KeyInfo);
                    if (error == 0)
                    {
                ...
                case 1:
                    ...
                    // decode: element
                    error = decode_iso20_acds_ObjectType(stream, &SignatureType->Object);
                    if (error == 0)
                    {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}EVUWBStrength; type={urn:iso:std:iso:15118:-20:CommonTypes}RationalNumberType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int decode_iso20_acds_RationalNumberType(exi_bitstream_t* stream, struct iso20_acds_RationalNumberType* RationalNumberType) {
    ...
    init_iso20_acds_RationalNumberType(RationalNumberType);
...
static int decode_iso20_acds_MessageHeaderType(exi_bitstream_t* stream, struct iso20_acds_MessageHeaderType* MessageHeaderType) {
    ...
    init_iso20_acds_MessageHeaderType(MessageHeaderType);
        ...
        case 67:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    error = decode_exi_type_hex_binary(stream, &MessageHeaderType->SessionID.bytesLen, &MessageHeaderType->SessionID.bytes[0], iso20_acds_sessionIDType_BYTES_SIZE);
                    if (error == 0)
                    {
                        grammar_id = 68;
                    }
        ...
        case 69:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SignatureType(stream, &MessageHeaderType->Signature);
                    if (error == 0)
                    {
...
static int decode_iso20_acds_SignaturePropertyType(exi_bitstream_t* stream, struct iso20_acds_SignaturePropertyType* SignaturePropertyType) {
    ...
    init_iso20_acds_SignaturePropertyType(SignaturePropertyType);
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignaturePropertyType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignaturePropertyType->Id.charactersLen, SignaturePropertyType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    if (error == 0)
                    {
                        if (SignaturePropertyType->Target.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignaturePropertyType->Target.charactersLen, SignaturePropertyType->Target.characters, iso20_acds_Target_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
        ...
        case 72:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    // Event: START (ANY, anyType (base64Binary)); next=2
                    // decode exi type: base64Binary
                    error = decode_exi_type_hex_binary(stream, &SignaturePropertyType->ANY.bytesLen, &SignaturePropertyType->ANY.bytes[0], iso20_acds_anyType_BYTES_SIZE);
                    if (error == 0)
                    {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}EVTechnicalStatus; type={urn:iso:std:iso:15118:-20:ACDS}EVTechnicalStatusType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
// Particle: EVReadyToCharge, boolean (1, 1); EVImmobilizationRequest, boolean (1, 1); EVImmobilized, boolean (0, 1); EVUWBStrength, RationalNumberType (0, 1); EVCPStatus, cpStatusType (0, 1); EVSOC, percentValueType (0, 1); EVErrorCode, errorCodeType (0, 1); EVTimeout, boolean (0, 1);
static int decode_iso20_acds_EVTechnicalStatusType(exi_bitstream_t* stream, struct iso20_acds_EVTechnicalStatusType* EVTechnicalStatusType) {
    int grammar_id = 73;
    int done = 0;
    uint32_t eventCode;
    ...
    init_iso20_acds_EVTechnicalStatusType(EVTechnicalStatusType);
    ...
    while(!done)
    {
        ...
        case 74:
            ...
            break;
        case 75:
            // Grammar: ID=75; read/write bits=3; START (EVImmobilized), START (EVUWBStrength), START (EVCPStatus), START (EVSOC), START (EVErrorCode), START (EVTimeout), END Element
            error = exi_basetypes_decoder_nbit_uint(stream, 3, &eventCode);
            if (error == 0)
            {
                switch(eventCode)
                ...
                case 0:
                    ...
                    break;
                case 1:
                    // Event: START (EVUWBStrength, RationalNumberType (RationalNumberType)); next=77
                    // decode: element
                    error = decode_iso20_acds_RationalNumberType(stream, &EVTechnicalStatusType->EVUWBStrength);
                    if (error == 0)
                    {
                        EVTechnicalStatusType->EVUWBStrength_isUsed = 1u;
                        grammar_id = 77;
                    }
                    break;
                case 2:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                EVTechnicalStatusType->EVCPStatus = (iso20_acds_cpStatusType)value;
                ...
                case 4:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                EVTechnicalStatusType->EVErrorCode = (iso20_acds_errorCodeType)value;
            ...
            break;
        case 76:
            // Grammar: ID=76; read/write bits=3; START (EVUWBStrength), START (EVCPStatus), START (EVSOC), START (EVErrorCode), START (EVTimeout), END Element
            error = exi_basetypes_decoder_nbit_uint(stream, 3, &eventCode);
            if (error == 0)
            {
                switch(eventCode)
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}ACDS_VehiclePositioningReq; type={urn:iso:std:iso:15118:-20:ACDS}ACDS_VehiclePositioningReqType; base type=V2GRequestType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int decode_iso20_acds_ACDS_VehiclePositioningReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_VehiclePositioningReqType* ACDS_VehiclePositioningReqType) {
    ...
    init_iso20_acds_ACDS_VehiclePositioningReqType(ACDS_VehiclePositioningReqType);
        ...
        case 81:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_VehiclePositioningReqType->Header);
                    if (error == 0)
                    {
                        grammar_id = 82;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningReqType->EVMobilityStatus = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningReqType->EVPositioningSupport = value;
                            }
                        }
                        else
                        {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}ACDS_VehiclePositioningRes; type={urn:iso:std:iso:15118:-20:ACDS}ACDS_VehiclePositioningResType; base type=V2GResponseType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int decode_iso20_acds_ACDS_VehiclePositioningResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_VehiclePositioningResType* ACDS_VehiclePositioningResType) {
    ...
    init_iso20_acds_ACDS_VehiclePositioningResType(ACDS_VehiclePositioningResType);
        ...
        case 84:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_VehiclePositioningResType->Header);
                    if (error == 0)
                    {
                        grammar_id = 85;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningResType->ResponseCode = (iso20_acds_responseCodeType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningResType->EVSEProcessing = (iso20_acds_processingType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningResType->EVSEPositioningSupport = value;
                            }
                        }
                        else
                        {
        ...
        case 88:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: short
                    error = decode_exi_type_integer16(stream, &ACDS_VehiclePositioningResType->EVRelativeXDeviation);
                    if (error == 0)
                    {
                        grammar_id = 89;
                    }
        ...
        case 89:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: short
                    error = decode_exi_type_integer16(stream, &ACDS_VehiclePositioningResType->EVRelativeYDeviation);
                    if (error == 0)
                    {
                        grammar_id = 90;
                    }
        ...
        case 90:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: short
                    error = decode_exi_type_integer16(stream, &ACDS_VehiclePositioningResType->ContactWindowXc);
                    if (error == 0)
                    {
                        grammar_id = 91;
                    }
        ...
        case 91:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: short
                    error = decode_exi_type_integer16(stream, &ACDS_VehiclePositioningResType->ContactWindowYc);
                    if (error == 0)
                    {
                        grammar_id = 92;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_VehiclePositioningResType->EVInChargePosition = value;
                            }
                        }
                        else
                        {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}ACDS_ConnectReq; type={urn:iso:std:iso:15118:-20:ACDS}ACDS_ConnectReqType; base type=V2GRequestType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int decode_iso20_acds_ACDS_ConnectReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_ConnectReqType* ACDS_ConnectReqType) {
    ...
    init_iso20_acds_ACDS_ConnectReqType(ACDS_ConnectReqType);
        ...
        case 93:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_ConnectReqType->Header);
                    if (error == 0)
                    {
                        grammar_id = 94;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_ConnectReqType->EVElectricalChargingDeviceStatus = (iso20_acds_electricalChargingDeviceStatusType)value;
                            }
                        }
                        else
                        {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}ACDS_ConnectRes; type={urn:iso:std:iso:15118:-20:ACDS}ACDS_ConnectResType; base type=V2GResponseType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int decode_iso20_acds_ACDS_ConnectResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_ConnectResType* ACDS_ConnectResType) {
    ...
    init_iso20_acds_ACDS_ConnectResType(ACDS_ConnectResType);
        ...
        case 95:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_ConnectResType->Header);
                    if (error == 0)
                    {
                        grammar_id = 96;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_ConnectResType->ResponseCode = (iso20_acds_responseCodeType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_ConnectResType->EVSEProcessing = (iso20_acds_processingType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_ConnectResType->EVSEElectricalChargingDeviceStatus = (iso20_acds_electricalChargingDeviceStatusType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_ConnectResType->EVSEMechanicalChargingDeviceStatus = (iso20_acds_mechanicalChargingDeviceStatusType)value;
                            }
                        }
                        else
                        {
...
// Element: definition=complex; name={urn:iso:std:iso:15118:-20:ACDS}ACDS_SystemStatusReq; type={urn:iso:std:iso:15118:-20:ACDS}ACDS_SystemStatusReqType; base type=V2GRequestType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int decode_iso20_acds_ACDS_SystemStatusReqType(exi_bitstream_t* stream, struct iso20_acds_ACDS_SystemStatusReqType* ACDS_SystemStatusReqType) {
    ...
    init_iso20_acds_ACDS_SystemStatusReqType(ACDS_SystemStatusReqType);
        ...
        case 100:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_SystemStatusReqType->Header);
                    if (error == 0)
                    {
                        grammar_id = 101;
                    }
        ...
        case 101:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_EVTechnicalStatusType(stream, &ACDS_SystemStatusReqType->EVTechnicalStatus);
                    if (error == 0)
                    {
                        grammar_id = 2;
                    }
...
static int decode_iso20_acds_ACDS_SystemStatusResType(exi_bitstream_t* stream, struct iso20_acds_ACDS_SystemStatusResType* ACDS_SystemStatusResType) {
    ...
    init_iso20_acds_ACDS_SystemStatusResType(ACDS_SystemStatusResType);
        ...
        case 102:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    // decode: element
                    error = decode_iso20_acds_MessageHeaderType(stream, &ACDS_SystemStatusResType->Header);
                    if (error == 0)
                    {
                        grammar_id = 103;
                    }
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->ResponseCode = (iso20_acds_responseCodeType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEMechanicalChargingDeviceStatus = (iso20_acds_mechanicalChargingDeviceStatusType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEReadyToCharge = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEIsolationStatus = (iso20_acds_isolationStatusType)value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEDisabled = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEUtilityInterruptEvent = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEEmergencyShutdown = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVSEMalfunction = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVInChargePosition = value;
                            }
                        }
                        else
                        {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (eventCode == 0)
                        {
                            ...
                            if (error == 0)
                            {
                                ACDS_SystemStatusResType->EVAssociationStatus = value;
                            }
                        }
                        else
                        {
...
static int decode_iso20_acds_ManifestType(exi_bitstream_t* stream, struct iso20_acds_ManifestType* ManifestType) {
    ...
    init_iso20_acds_ManifestType(ManifestType);
        ...
        case 113:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (ManifestType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, ManifestType->Id.charactersLen, ManifestType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    // decode: element array
                    if (ManifestType->Reference.arrayLen < iso20_acds_ReferenceType_4_ARRAY_SIZE)
                    {
                        error = decode_iso20_acds_ReferenceType(stream, &ManifestType->Reference.array[ManifestType->Reference.arrayLen++]);
                    }
                    else
                    {
                        error = EXI_ERROR__ARRAY_OUT_OF_BOUNDS;
...
static int decode_iso20_acds_SignaturePropertiesType(exi_bitstream_t* stream, struct iso20_acds_SignaturePropertiesType* SignaturePropertiesType) {
    ...
    init_iso20_acds_SignaturePropertiesType(SignaturePropertiesType);
        ...
        case 123:
            ...
            if (error == 0)
            {
                ...
                case 0:
                    ...
                    if (error == 0)
                    {
                        if (SignaturePropertiesType->Id.charactersLen >= 2)
                        {
                            ...
                            error = exi_basetypes_decoder_characters(stream, SignaturePropertiesType->Id.charactersLen, SignaturePropertiesType->Id.characters, iso20_acds_Id_CHARACTER_SIZE);
                        }
                        else
                        {
                            // the string seems to be in the table, but this is not supported
                ...
                case 1:
                    ...
                    // decode: element
                    error = decode_iso20_acds_SignaturePropertyType(stream, &SignaturePropertiesType->SignatureProperty);
                    if (error == 0)
                    {
                        grammar_id = 124;
                    }
...
int decode_iso20_acds_exiDocument(exi_bitstream_t* stream, struct iso20_acds_exiDocument* exiDoc) {
    ...
    if (error == 0)
    {
        init_iso20_acds_exiDocument(exiDoc);
        ...
        if (error == 0)
        {
            ...
            {
            case 0:
                error = decode_iso20_acds_ACDS_ConnectReqType(stream, &exiDoc->ACDS_ConnectReq);
                exiDoc->ACDS_ConnectReq_isUsed = 1u;
                break;
            case 1:
                error = decode_iso20_acds_ACDS_ConnectReqType(stream, &exiDoc->ACDS_DisconnectReq);
                exiDoc->ACDS_DisconnectReq_isUsed = 1u;
                break;
            case 2:
                error = decode_iso20_acds_ACDS_ConnectResType(stream, &exiDoc->ACDS_ConnectRes);
                exiDoc->ACDS_ConnectRes_isUsed = 1u;
                break;
            case 3:
                error = decode_iso20_acds_ACDS_ConnectResType(stream, &exiDoc->ACDS_DisconnectRes);
                exiDoc->ACDS_DisconnectRes_isUsed = 1u;
                break;
            case 4:
                error = decode_iso20_acds_ACDS_SystemStatusReqType(stream, &exiDoc->ACDS_SystemStatusReq);
                exiDoc->ACDS_SystemStatusReq_isUsed = 1u;
                break;
            case 5:
                error = decode_iso20_acds_ACDS_SystemStatusResType(stream, &exiDoc->ACDS_SystemStatusRes);
                exiDoc->ACDS_SystemStatusRes_isUsed = 1u;
                break;
            case 6:
                error = decode_iso20_acds_ACDS_VehiclePositioningReqType(stream, &exiDoc->ACDS_VehiclePositioningReq);
                exiDoc->ACDS_VehiclePositioningReq_isUsed = 1u;
                break;
            case 7:
                error = decode_iso20_acds_ACDS_VehiclePositioningResType(stream, &exiDoc->ACDS_VehiclePositioningRes);
                exiDoc->ACDS_VehiclePositioningRes_isUsed = 1u;
                break;
            case 8:
                error = decode_iso20_acds_CLReqControlModeType(stream, &exiDoc->CLReqControlMode);
                exiDoc->CLReqControlMode_isUsed = 1u;
                break;
            case 9:
                error = decode_iso20_acds_CLResControlModeType(stream, &exiDoc->CLResControlMode);
                exiDoc->CLResControlMode_isUsed = 1u;
                break;
            case 10:
                error = decode_iso20_acds_CanonicalizationMethodType(stream, &exiDoc->CanonicalizationMethod);
                exiDoc->CanonicalizationMethod_isUsed = 1u;
                break;
            case 11:
                error = decode_iso20_acds_DSAKeyValueType(stream, &exiDoc->DSAKeyValue);
                exiDoc->DSAKeyValue_isUsed = 1u;
                break;
            case 12:
                error = decode_iso20_acds_DigestMethodType(stream, &exiDoc->DigestMethod);
                exiDoc->DigestMethod_isUsed = 1u;
                break;
            case 13:
                // simple type! decode_iso20_acds_DigestValue;
                break;
            case 14:
                error = decode_iso20_acds_KeyInfoType(stream, &exiDoc->KeyInfo);
                exiDoc->KeyInfo_isUsed = 1u;
                break;
            case 15:
                // simple type! decode_iso20_acds_KeyName;
                break;
            case 16:
                error = decode_iso20_acds_KeyValueType(stream, &exiDoc->KeyValue);
                exiDoc->KeyValue_isUsed = 1u;
                break;
            case 17:
                error = decode_iso20_acds_ManifestType(stream, &exiDoc->Manifest);
                exiDoc->Manifest_isUsed = 1u;
                break;
            case 18:
                // simple type! decode_iso20_acds_MgmtData;
                break;
            case 19:
                error = decode_iso20_acds_ObjectType(stream, &exiDoc->Object);
                exiDoc->Object_isUsed = 1u;
                break;
            case 20:
                error = decode_iso20_acds_PGPDataType(stream, &exiDoc->PGPData);
                exiDoc->PGPData_isUsed = 1u;
                break;
            case 21:
                error = decode_iso20_acds_RSAKeyValueType(stream, &exiDoc->RSAKeyValue);
                exiDoc->RSAKeyValue_isUsed = 1u;
                break;
            case 22:
                error = decode_iso20_acds_ReferenceType(stream, &exiDoc->Reference);
                exiDoc->Reference_isUsed = 1u;
                break;
            case 23:
                error = decode_iso20_acds_RetrievalMethodType(stream, &exiDoc->RetrievalMethod);
                exiDoc->RetrievalMethod_isUsed = 1u;
                break;
            case 24:
                error = decode_iso20_acds_SPKIDataType(stream, &exiDoc->SPKIData);
                exiDoc->SPKIData_isUsed = 1u;
                break;
            case 25:
                error = decode_iso20_acds_SignatureMethodType(stream, &exiDoc->SignatureMethod);
                exiDoc->SignatureMethod_isUsed = 1u;
                break;
            case 26:
                error = decode_iso20_acds_SignaturePropertiesType(stream, &exiDoc->SignatureProperties);
                exiDoc->SignatureProperties_isUsed = 1u;
                break;
            case 27:
                error = decode_iso20_acds_SignaturePropertyType(stream, &exiDoc->SignatureProperty);
                exiDoc->SignatureProperty_isUsed = 1u;
                break;
            case 28:
                error = decode_iso20_acds_SignatureType(stream, &exiDoc->Signature);
                exiDoc->Signature_isUsed = 1u;
                break;
            case 29:
                error = decode_iso20_acds_SignatureValueType(stream, &exiDoc->SignatureValue);
                exiDoc->SignatureValue_isUsed = 1u;
                break;
            case 30:
                error = decode_iso20_acds_SignedInfoType(stream, &exiDoc->SignedInfo);
                exiDoc->SignedInfo_isUsed = 1u;
                break;
            case 31:
                error = decode_iso20_acds_TransformType(stream, &exiDoc->Transform);
                exiDoc->Transform_isUsed = 1u;
                break;
            case 32:
                error = decode_iso20_acds_TransformsType(stream, &exiDoc->Transforms);
                exiDoc->Transforms_isUsed = 1u;
                break;
            case 33:
                error = decode_iso20_acds_X509DataType(stream, &exiDoc->X509Data);
