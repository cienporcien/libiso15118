...
using ControlEvent =
    std::variant<CableCheckFinished, PresentVoltageCurrent, AuthorizationResponse, StopCharging, DcTransferLimits, VehiclePositioningFinished, ACDPConnectFinished>;
